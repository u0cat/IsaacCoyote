#ifndef ISAACCOYOTE_USE_ACTIVE_ITEM_HANDLER_H
#define ISAACCOYOTE_USE_ACTIVE_ITEM_HANDLER_H

#include "app/rule/handlers/rule_handler.h"

namespace app::rule
{
    class UseActiveItemHandler final : public EventRuleHandler {
    public:
...
#endif // ISAACCOYOTE_USE_ACTIVE_ITEM_HANDLER_H
