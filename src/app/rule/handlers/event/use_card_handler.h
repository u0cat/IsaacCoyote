#ifndef ISAACCOYOTE_USE_CARD_HANDLER_H
#define ISAACCOYOTE_USE_CARD_HANDLER_H

#include "app/rule/handlers/rule_handler.h"

namespace app::rule
{
    class UseCardHandler final : public EventRuleHandler {
    public:
...
#endif // ISAACCOYOTE_USE_CARD_HANDLER_H
