...
#ifndef ISAACSPY_ENUMS_H
#define ISAACSPY_ENUMS_H
#include <cstdint>

namespace isaac_spy::isaac::enums
{
    ...
    enum class SlotVariant {
        SLOT_MACHINE = 1,               // 赌博机
        BLOOD_DONATION_MACHINE,     // 献血机
        FORTUNE_TELLING_MACHINE,    // 预言机
        BEGGAR,                     // 乞丐
        DEVIL_BEGGAR,               // 恶魔乞丐
        SHELL_GAME,                 // 赌博乞丐
        KEY_MASTER,                 // 钥匙大师
        DONATION_MACHINE,           // 捐款机
        BOMB_BUM,                   // 炸弹乞丐
        SHOP_RESTOCK_MACHINE,       // 补货机
        GREED_DONATION_MACHINE,     // 贪婪捐款机
        MOMS_DRESSING_TABLE,        // 妈妈的梳妆台
        BATTERY_BUM,                // 电池乞丐
        ISAAC_SECRET,               // 隐藏以撒
        HELL_GAME,                  // 赌命乞丐
        CRANE_GAME,                 // 夹娃娃机
    ...
    enum class DamageFlag: uint64_t {
        DAMAGE_NOKILL            = 1,
        DAMAGE_FIRE              = 1 << 1,
        ...
        DAMAGE_SPAWN_CARD        = 1ULL << 31,
        DAMAGE_SPAWN_RUNE        = 1ULL << 32,
    };
    ...
    enum CardType {
        ...
        CARDTYPE_RUNE,
        CARDTYPE_SPECIAL,
        CARDTYPE_SPECIAL_OBJECT,
        CARDTYPE_TAROT_REVERSE,
        CARDTYPE_NOT_CARD
    };
}

#endif //ISAACSPY_ENUMS_H
